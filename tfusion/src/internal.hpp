...
namespace tfusion
{
    namespace device
    {
        ...
        public:
            ...
            __tf_device__ elem_type* operator()(int x, int y, int z);
            __tf_device__ const elem_type* operator() (int x, int y, int z) const ;
            __tf_device__ elem_type* beg(int x, int y) const;
            __tf_device__ elem_type* zstep(elem_type *const ptr) const;
        private:
        ...
        struct Projector
        {
            ...
            __tf_device__ float2 operator()(const float3& p) const;
        };
        ...
        struct Reprojector
        {
            ...
            float2 finv, c;
            __tf_device__ float3 operator()(int x, int y, float z) const;
        };
        ...
        struct ComputeIcpHelper
        {
            ...
            //private:
            __tf_device__ int find_coresp(int x, int y, float3& n, float3& d, float3& s) const;
            __tf_device__ void partial_reduce(const float row[7], PtrStep<float>& partial_buffer) const;
            __tf_device__ float2 proj(const float3& p) const;
            __tf_device__ float3 reproj(float x, float y, float z)  const;
        };
        ...
        __tf_device__ ushort2 pack_tsdf(float tsdf, int weight);
        __tf_device__ float unpack_tsdf(ushort2 value, int& weight);
        __tf_device__ float unpack_tsdf(ushort2 value);
