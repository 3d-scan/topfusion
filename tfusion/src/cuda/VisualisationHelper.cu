...
__global__ void tfusion::countVisibleBlocks_device(const int *visibleEntryIDs, int noVisibleEntries, const HashEntry *hashTable, uint *noBlocks, int minBlockId, int maxBlockId)
{
...
__global__ void tfusion::buildCompleteVisibleList_device(const HashEntry *hashTable, /*HashCacheState *cacheStates, bool useSwapping,*/ int noTotalEntries,
...
__global__ void tfusion::projectAndSplitBlocks_device(const HashEntry *hashEntries, const int *visibleEntryIDs, int noVisibleEntries,
...
__global__ void tfusion::checkProjectAndSplitBlocks_device(const HashEntry *hashEntries, int noHashEntries,
	const Matrix4f pose_M, const Vector4f intrinsics, const Vector2i imgSize, float voxelSize, RenderingBlock *renderingBlocks,
	uint *noTotalBlocks)
{
...
__global__ void tfusion::fillBlocks_device(uint noTotalBlocks, const RenderingBlock *renderingBlocks,
...
__global__ void tfusion::findMissingPoints_device(int *fwdProjMissingPoints, uint *noMissingPoints, const Vector2f *minmaximg,
...
__global__ void tfusion::forwardProject_device(Vector4f *forwardProjection, const Vector4f *pointsRay, Vector2i imgSize, Matrix4f M,
