...
tfusion::device::ComputeIcpHelper::ComputeIcpHelper(float dist_thres, float angle_thres)
{
    min_cosine = cos(angle_thres);
    dist2_thres = dist_thres * dist_thres;
}

void tfusion::device::ComputeIcpHelper::setLevelIntr(int level_index, float fx, float fy, float cx, float cy)
{
...
struct tfusion::cuda::ProjectiveICP::StreamHelper
{
...
tfusion::cuda::ProjectiveICP::ProjectiveICP() : angle_thres_(deg2rad(20.f)), dist_thres_(0.1f)
{ 
...
tfusion::cuda::ProjectiveICP::~ProjectiveICP() {}

float tfusion::cuda::ProjectiveICP::getDistThreshold() const
{ return dist_thres_; }

void tfusion::cuda::ProjectiveICP::setDistThreshold(float distance)
{ dist_thres_ = distance; }

float tfusion::cuda::ProjectiveICP::getAngleThreshold() const
{ return angle_thres_; }

void tfusion::cuda::ProjectiveICP::setAngleThreshold(float angle)
{ angle_thres_ = angle; }

void tfusion::cuda::ProjectiveICP::setIterationsNum(const std::vector<int>& iters)
{
...
int tfusion::cuda::ProjectiveICP::getUsedLevelsNum() const
{
...
bool tfusion::cuda::ProjectiveICP::estimateTransform(Affine3f& /*affine*/, const Intr& /*intr*/, const Frame& /*curr*/, const Frame& /*prev*/)
{
...
bool tfusion::cuda::ProjectiveICP::estimateTransform(Affine3f& affine, const Intr& intr, const DepthPyr& dcurr, const NormalsPyr ncurr, const DepthPyr dprev, const NormalsPyr nprev)
{
...
bool tfusion::cuda::ProjectiveICP::estimateTransform(Affine3f& affine, const Intr& intr, const PointsPyr& vcurr, const NormalsPyr ncurr, const PointsPyr vprev, const NormalsPyr nprev)
{
    const int LEVELS = getUsedLevelsNum();
    StreamHelper& sh = *shelp_;
