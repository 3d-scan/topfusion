...
_CPU_AND_GPU_CODE_ inline int findVoxel(const CONSTPTR(tfusion::VoxelBlockHash::IndexData) *voxelIndex, const THREADPTR(Vector3i) & point,
	THREADPTR(int) &vmIndex, THREADPTR(tfusion::VoxelBlockHash::IndexCache) & cache)
{
	Vector3i blockPos;
...
_CPU_AND_GPU_CODE_ inline int findVoxel(const CONSTPTR(tfusion::VoxelBlockHash::IndexData) *voxelIndex, Vector3i point, THREADPTR(int) &vmIndex)
{
	tfusion::VoxelBlockHash::IndexCache cache;
	return findVoxel(voxelIndex, point, vmIndex, cache);
}

_CPU_AND_GPU_CODE_ inline int findVoxel(const CONSTPTR(tfusion::VoxelBlockHash::IndexData) *voxelIndex, Vector3i point, THREADPTR(bool) &foundPoint)
{
	int vmIndex;
	tfusion::VoxelBlockHash::IndexCache cache;
...
_CPU_AND_GPU_CODE_ inline TVoxel readVoxel(const CONSTPTR(TVoxel) *voxelData, const CONSTPTR(tfusion::VoxelBlockHash::IndexData) *voxelIndex,
	const THREADPTR(Vector3i) & point, THREADPTR(int) &vmIndex, THREADPTR(tfusion::VoxelBlockHash::IndexCache) & cache)
{
	Vector3i blockPos;
...
// _CPU_AND_GPU_CODE_ inline int findVoxel(const CONSTPTR(tfusion::PlainVoxelArray::IndexData) *voxelIndex, const THREADPTR(Vector3i) & point_orig,
...
// _CPU_AND_GPU_CODE_ inline int findVoxel(const CONSTPTR(tfusion::PlainVoxelArray::IndexData) *voxelIndex, const THREADPTR(Vector3i) & point_orig,
// 	THREADPTR(int) &vmIndex, THREADPTR(tfusion::PlainVoxelArray::IndexCache) & cache)
// {
...
// template<class TVoxel>
// _CPU_AND_GPU_CODE_ inline TVoxel readVoxel(const CONSTPTR(TVoxel) *voxelData, const CONSTPTR(tfusion::PlainVoxelArray::IndexData) *voxelIndex,
...
// template<class TVoxel>
// _CPU_AND_GPU_CODE_ inline TVoxel readVoxel(const CONSTPTR(TVoxel) *voxelData, const CONSTPTR(tfusion::PlainVoxelArray::IndexData) *voxelIndex,
// 	const THREADPTR(Vector3i) & point_orig, THREADPTR(int) &vmIndex, THREADPTR(tfusion::PlainVoxelArray::IndexCache) & cache)
// {
