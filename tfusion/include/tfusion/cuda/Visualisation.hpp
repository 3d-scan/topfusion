...
#include "../Interface/VisualisationEngine.h"
...
namespace tfusion
{
	...
	class VisualisationEngine_CUDA<TVoxel, VoxelBlockHash> : public VisualisationEngine < TVoxel, VoxelBlockHash >
	{
	private:
		uint *noTotalPoints_device;
	...
	public:
		...
		RenderState_VH* CreateRenderState(const Scene<TVoxel, VoxelBlockHash> *scene, const Vector2i & imgSize) const;
		void FindVisibleBlocks(const Scene<TVoxel,VoxelBlockHash> *scene, const ORUtils::SE3Pose *pose, const Intrinsics *intrinsics, RenderState *renderState) const;
		int CountVisibleBlocks(const Scene<TVoxel,VoxelBlockHash> *scene, const RenderState *renderState, int minBlockId, int maxBlockId) const;
		void CreateExpectedDepths(const Scene<TVoxel,VoxelBlockHash> *scene, const ORUtils::SE3Pose *pose, const Intrinsics *intrinsics, RenderState *renderState) const;
		void RenderImage(const Scene<TVoxel,VoxelBlockHash> *scene, const ORUtils::SE3Pose *pose, const Intrinsics *intrinsics, const RenderState *renderState,
			UChar4Image *outputImage, IVisualisationEngine::RenderImageType type = IVisualisationEngine::RENDER_SHADED_GREYSCALE,
			IVisualisationEngine::RenderRaycastSelection raycastType = IVisualisationEngine::RENDER_FROM_NEW_RAYCAST) const;
		void FindSurface(const Scene<TVoxel,VoxelBlockHash> *scene, const ORUtils::SE3Pose *pose, const Intrinsics *intrinsics, const RenderState *renderState) const;
		void CreatePointCloud(const Scene<TVoxel,VoxelBlockHash> *scene, const View *view, TrackingState *trackingState, RenderState *renderState, bool skipPoints) const;
		void CreateICPMaps(const Scene<TVoxel,VoxelBlockHash> *scene, const View *view, TrackingState *trackingState, RenderState *renderState) const;
		void ForwardRender(const Scene<TVoxel,VoxelBlockHash> *scene, const View *view, TrackingState *trackingState, RenderState *renderState) const;
	};
}