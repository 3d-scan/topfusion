...
namespace tfusion
{
	...
	__global__ void buildCompleteVisibleList_device(const HashEntry *hashTable, /*HashCacheState *cacheStates, bool useSwapping,*/ int noTotalEntries,
	...
	__global__ void countVisibleBlocks_device(const int *visibleEntryIDs, int noVisibleEntries, const HashEntry *hashTable, uint *noBlocks, int minBlockId, int maxBlockId);

	__global__ void projectAndSplitBlocks_device(const HashEntry *hashEntries, const int *visibleEntryIDs, int noVisibleEntries,
